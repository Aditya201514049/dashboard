...
export default function Home() {
  ...
  const handleAuthRequiredAction = (e) => {
    e.preventDefault();
    router.push('/signin');
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8 max-w-4xl">
      ...
      {user ? (
        ...
        <div>
          <div className="text-center p-6 bg-base-200 rounded-lg shadow-md mb-8">
            ...
            <p className="text-lg md:text-xl mb-6">Explore our features or sign in to access your personal dashboard</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div onClick={handleAuthRequiredAction} className="card bg-secondary text-secondary-content shadow-xl p-4 md:p-6 hover:scale-105 transition-transform cursor-pointer">
              <div className="flex items-center mb-2">
                <BarChart2 className="h-6 w-6 mr-2 text-secondary-content" />
                <h2 className="text-xl md:text-2xl font-bold">Dashboard</h2>
              </div>
            ...
            <div onClick={handleAuthRequiredAction} className="card bg-accent text-accent-content shadow-xl p-4 md:p-6 hover:scale-105 transition-transform cursor-pointer">
              <div className="flex items-center mb-2">
                <User className="h-6 w-6 mr-2 text-accent-content" />
                <h2 className="text-xl md:text-2xl font-bold">User Profile</h2>
              </div>
